...
Shader "SC Lasers/Bloom" {
	...
	half4 _MainTex_ST, _SourceTex_ST;
		...
		SubShader{
			...
			Pass { // 3
				CGPROGRAM
					...
					half4 FragmentProgram(Interpolators i) : SV_Target {
						half4 c = tex2D(_SourceTex, UnityStereoScreenSpaceUVAdjust(i.uv, _SourceTex_ST));
